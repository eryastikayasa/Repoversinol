...
/* Exactly one 20 ms microphone frame per TX command. */
#define WS_TX_AUDIO_SIZE 640
#define WS_TX_QUEUE_LENGTH 2
#define WS_TX_POOL_COUNT WS_TX_QUEUE_LENGTH
#define WS_RX_QUEUE_LENGTH WS_RX_SLOT_COUNT
#define WS_TX_POOL_NONE 0xFF
...
extern volatile uint8_t gemini_volume_percent;
void set_gemini_volume(uint8_t percent);
uint8_t get_gemini_volume(void);
